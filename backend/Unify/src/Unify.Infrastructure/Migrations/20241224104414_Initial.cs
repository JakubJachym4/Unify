    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_homework_assigment", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_homework_submission", x => x.id);
                    table.ForeignKey(
                        name: "fk_homework_submission_homework_assigment_homework_assigment_id",
                        column: x => x.homework_assigment_id,
                        principalTable: "homework_assigment",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    student_id = table.Column<Guid>(type: "uuid", nullable: false),
                    student_group_id = table.Column<Guid>(type: "uuid", nullable: false),
                    enrollment_on = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    class_enrollment_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.class_enrollment_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    homework_assigment_id = table.Column<Guid>(type: "uuid", nullable: true),
                    homework_submission_id = table.Column<Guid>(type: "uuid", nullable: true),
                    online_resource_id = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.online_resource_id,
                        principalTable: "course_resources",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_attachments_homework_assigment_homework_assigment_id",
                        column: x => x.homework_assigment_id,
                        principalTable: "homework_assigment",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    homework_assigment_id = table.Column<Guid>(type: "uuid", nullable: false),
                    homework_submission_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_homework_bases_attachments", x => new { x.attachment_id, x.homework_base_id });
                    table.ForeignKey(
                        name: "fk_homework_bases_attachments_attachments_attachment_id",
                        column: x => x.attachment_id,
                        principalTable: "attachments",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_homework_bases_attachments_homework_assigment_homework_assi",
                        column: x => x.homework_assigment_id,
                        principalTable: "homework_assigment",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_homework_bases_attachments_homework_submission_homework_sub",
                        column: x => x.homework_submission_id,
                        principalTable: "homework_submission",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_attachments_homework_assigment_id",
                table: "attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_homework_bases_attachments_homework_assigment_id",
                table: "homework_bases_attachments",
                column: "homework_assigment_id");

            migrationBuilder.CreateIndex(
                name: "ix_homework_bases_attachments_homework_submission_id",
                table: "homework_bases_attachments",
                column: "homework_submission_id");

            migrationBuilder.CreateIndex(
                name: "ix_homework_submission_homework_assigment_id",
